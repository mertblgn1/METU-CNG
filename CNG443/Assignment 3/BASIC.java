...
public class BASIC {
    ...
    public static void main(String[] args) {
        users.addAll(GoldIO.readFromFile());
        users.addAll(StandardIO.readFromFile());
        users.addAll(HostIO.readFromFile());
        properties.addAll(SharedPropertyIO.readFromFile());
        properties.addAll(FullPropertyIO.readFromFile());
